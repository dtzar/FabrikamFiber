...
Param(
  ...
  [string] $ResourceGroupName = 'FabrikamFiber.CallCenter',
  [switch] $UploadArtifacts,
  [string] $StorageAccountName, 
  [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
  [string] $TemplateFile = '..\Templates\FabrikamFiberTemplate.json',
  [string] $TemplateParametersFile = '..\Templates\FabrikamFiberTemplate.param.dev.json',
